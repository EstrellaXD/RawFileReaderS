...
/// </summary>
internal class FtCentroidPacket : AdvancedPacketBase
{
	/// <summary>
	...
	public FtCentroidPacket(IMemoryReader viewer, long offset, int fileRevision, bool includeRefPeaks = false, PacketFeatures packetScanDataFeatures = PacketFeatures.All)
