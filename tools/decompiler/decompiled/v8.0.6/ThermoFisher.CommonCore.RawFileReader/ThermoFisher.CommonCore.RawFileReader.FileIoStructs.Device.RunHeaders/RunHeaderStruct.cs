...
internal struct RunHeaderStruct
{
	/// <summary>
	...
	///     can be PPM, AMU, MMU
	/// </summary>
	internal int ToleranceUnit;

	/// <summary>
	///     how many digits to display in filter strings.
	/// </summary>
	internal int FilterMassPrecision;

	/// <summary>
	///     Offset of where the scan indexes starts in the virtual controller data
	/// </summary>
	internal long SpectPos;

	/// <summary>
	///     offset of where the virtual data starts in the virtual controller data
	/// </summary>
	internal long PacketPos;

	/// <summary>
	///     offset of where the status log starts in the virtual controller data
	/// </summary>
	internal long StatusLogPos;

	/// <summary>
	///     offset of where the error log starts in the virtual controller data
	/// </summary>
	internal long ErrorLogPos;

	/// <summary>
	///     offset of where the run header starts in the virtual controller data
	/// </summary>
	internal long RunHeaderPos;

	internal long TrailerScanEventsPos;

	internal long TrailerExtraPos;

	internal VirtualControllerInfoStruct ControllerInfo;

	/// <summary>
	///     Extra file pointers and counts for later use.
	/// </summary>
	internal long Extra0Pos;

	internal int Extra0Count;

	internal long Extra1Pos;

	internal int Extra1Count;

	internal long Extra2Pos;

	internal int Extra2Count;

	internal long Extra3Pos;

	internal int Extra3Count;

	internal long Extra4Pos;

	internal int Extra4Count;

	internal long Extra5Pos;

	internal int Extra5Count;
