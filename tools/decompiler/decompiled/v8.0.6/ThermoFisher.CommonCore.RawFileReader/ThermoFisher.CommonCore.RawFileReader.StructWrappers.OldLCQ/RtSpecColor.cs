...
/// </summary>
internal sealed class RtSpecColor : IRawObjectBase
{
	/// <summary>
	/// Load (from file).
	/// </summary>
	...
	public long Load(IMemoryReader viewer, long dataOffset, int fileRevision)
	{
		...
		int count = ((fileRevision >= 39) ? Marshal.SizeOf(typeof(RtSpecColorStruct)) : Marshal.SizeOf(typeof(RtSpecColorStruct1)));
