...
/// </summary>
internal sealed class InstMethodColumnInfo : IRawObjectBase
{
	/// <summary>
	/// Load (from file).
	/// </summary>
	...
	public long Load(IMemoryReader viewer, long dataOffset, int fileRevision)
	{
		...
		long num = Marshal.SizeOf(typeof(InstMethodColumnInfoStruct));
		viewer.ReadBytesExt(ref startPos, (int)num);
